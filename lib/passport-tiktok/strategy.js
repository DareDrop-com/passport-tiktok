...
Strategy.prototype.userProfile = function (accessToken, authData, done) {
  ...
  this._oauth2._request('POST', url, {}, JSON.stringify(params), accessToken, function (err, body, res) {
    ...
    try {
        ...
        try {
          self._oauth2.get(location, null, function (error, buffer, incomingProfileUrlMessage) {
            try {
              ...
              console.info('Failed to retrieve profile username')
              console.info('profile response', json)
              console.info('incomingProfileUrlMessage', incomingProfileUrlMessage);
              console.info('incomingShortenedUrlMessage', incomingShortenedUrlMessage);
              console.error(e)
              console.error(error)
          ...
          console.info('Failed to get username')
          console.info('incomingShortenedUrlMessage', incomingShortenedUrlMessage)
          console.info('profile response', json)
          console.error(e)
      ...
      console.info('Failed to get profile')
      console.error(e)
      done(e);
    }
