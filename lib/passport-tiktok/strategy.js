...
function Strategy(options, verify) {
  ...
  options.scope = options.scope || ['user.info.basic', 'user.info.profile']
      ...
      return userInfoResponse.json()
        .then((userInfo) => {
          ...
          return _fetch(user.profile_web_link, {
            ...
            .then((profileLinkResponse) => {
              var profileUrl = profileLinkResponse.url
            ...
            .catch(err => {
              ...
              console.info(TIKTOK_STRATEGY_PREFIX, userInfo)
