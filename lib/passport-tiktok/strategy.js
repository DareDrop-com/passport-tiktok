...
var isFunction = require('lodash/isFunction'), isObjectLike = require('lodash/isObjectLike'),
  isString = require('lodash/isString'), isUndefined = require('lodash/isUndefined'), util = require('util'),
  ...
  this._oauth2.get(`${url}?${parsedParams}`, accessToken, function (err, body, res) {
    ...
    try {
      ...
      self._oauth2.get(json.data.user.profile_deep_link, null, function (_, __, incomingShortenedUrlMessage) {
        ...
        self._oauth2.get(location, null, function (___, ____, incomingProfileUrlMessage) {
          var profile = {
            provider: 'tiktok',
